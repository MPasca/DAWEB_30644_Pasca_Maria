        ...
        <div style={{display: "inline-flex"}}>
            <div style={{display:"block", width:"80%", marginTop:"-3%"}}>
                ...
                <div style={{}}>
                    ...
                    <div>
                        <SearchDate/>
                        <button class="btnNav" style={{ display:"flow", marginLeft:"75%", marginTop:"-5%"}} onClick={clickNextDate}>Next</button>
                        <button class="btnNav" style={{ display:"flow", marginLeft:"0%", marginTop:"-5%"}} onClick={clickBackDate}>Back</button>
                    </div>}

                    {showPeople &&
                    <div>
                        <SearchPeople/>
                        <Link to="/destinations"><button class="btnNav" style={{ display:"flow", marginLeft:"75%", marginTop:"-5%"}} >Next</button></Link>
                        <button class="btnNav" style={{ display:"flow", marginLeft:"0%", marginTop:"-5%"}} onClick={clickBackPeople}>Back</button>
                    </div>}
                </div>
            </div>

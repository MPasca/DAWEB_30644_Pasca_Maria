...
export default function Dashboard () {
    ...
    const handleEdit = (destination) => {
        console.log("in handle edit for destination id: " + destination.id);
        <UpdateDestination crtDestination={destination}/>
    }
        ...
        <div style={{display:"flex", flexDirection:"row", alignItems:"center"}}>
            ...
            <div style={{display:"flex", flexDirection:"column", alignItems:"center"}}>
                <div style={{display:"flex", flexDirection:"row", border:"1px solid black", borderRadius:"10px", backgroundColor:"#D9D9D9", padding:"20px", alignItems:"center", marginBottom:"20px"}}>
                    ...
                    <button style={{fontFamily:"'Segoe UI', Tahoma, Geneva, Verdana, sans-serif", fontSize:"24px"}}>Add</button>
                </div>
                <div style={{display:"flex", flexDirection:"row", border:"1px solid black", borderRadius:"10px", backgroundColor:"#D9D9D9", padding:"20px", alignItems:"center", marginBottom:"20px"}}>
                    ...
                    <button style={{fontFamily:"'Segoe UI', Tahoma, Geneva, Verdana, sans-serif", fontSize:"24px"}}>Update</button>
                </div>
